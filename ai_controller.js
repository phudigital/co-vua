...
class AIController {
    constructor() {
        ...
        this.enginePath = 'https://cdnjs.cloudflare.com/ajax/libs/stockfish.js/10.0.2/stockfish.js';
    ...
    getEngineMove(fen, callback) {
        ...
        switch (this.level) {
            case 3: depth = 5; movetime = 800; skill = 3; break; // Vừa
            case 4: depth = 10; movetime = 1500; skill = 10; break; // Hơi khó
            case 5: depth = 15; movetime = 3000; skill = 20; break; // Khó
        }
